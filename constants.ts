// Replace these URLs with the actual uploaded images if hosting locally or on a CDN
// For now, we use placeholders that closely match the description or generic ones.
